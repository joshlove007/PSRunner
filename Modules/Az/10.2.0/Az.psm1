...
Import-Module Az.Cdn -RequiredVersion 3.1.0 -Global
...
Import-Module Az.Compute -RequiredVersion 6.2.0 -Global
...
Import-Module Az.ContainerRegistry -RequiredVersion 4.1.0 -Global
Import-Module Az.CosmosDB -RequiredVersion 1.11.2 -Global
...
Import-Module Az.DataProtection -RequiredVersion 2.0.0 -Global
...
Import-Module Az.Maintenance -RequiredVersion 1.3.0 -Global
...
Import-Module Az.Monitor -RequiredVersion 4.5.0 -Global
Import-Module Az.MySql -RequiredVersion 1.1.1 -Global
Import-Module Az.Network -RequiredVersion 6.1.1 -Global
...
Import-Module Az.PolicyInsights -RequiredVersion 1.6.2 -Global
...
Import-Module Az.RecoveryServices -RequiredVersion 6.5.0 -Global
...
Import-Module Az.Resources -RequiredVersion 6.9.0 -Global
...
Import-Module Az.Sql -RequiredVersion 4.9.0 -Global
Import-Module Az.SqlVirtualMachine -RequiredVersion 2.0.0 -Global
Import-Module Az.StackHCI -RequiredVersion 2.1.0 -Global
Import-Module Az.Storage -RequiredVersion 5.9.0 -Global
...
Import-Module Az.Synapse -RequiredVersion 3.0.2 -Global
Import-Module Az.TrafficManager -RequiredVersion 1.2.1 -Global
Import-Module Az.Websites -RequiredVersion 3.1.0 -Global
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCOhQHjLdQXM50x
# MMKR3V5nmO+jLQlMRFXWVT2udDCaK6CCDYUwggYDMIID66ADAgECAhMzAAADTU6R
...
# Xb5Yz9nIgnop7ZkjYnOgwHWfFJE7YChIQlUhK0KEMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAIoQ6uU/uJieCntPbCS2zm/1wMXD3G3ADicBD
# fJOCYgQwec3OBfxzgz9gOli1frHrcHmrkb+J//NMveTxBsvtwYIy0OK86EsHPpKs
# GijH5Pzwne2LJQdymMic+kzZIPpNT2eZvtfc6nn6Gr4mwhs/3uz8SgFlCKOsW6yq
# VOzY+6bGbgOpA9gZjoGMCRgDzjXeP6VLTo8m4JG97JJFfyuyBKK8rXNbL1h+R48C
# vl4G1xVl5qBJygNcT/7gJHvDV082QvdIYLVaWdLI2rFsVkkLfiW0rB7NDNmxkbyN
# xzCCOPqT6X7fBGVgiSVJYLhoumS8+IawytUMhUi2+qBqy9FQG6GCFykwghclBgor
# BgEEAYI3AwMBMYIXFTCCFxEGCSqGSIb3DQEHAqCCFwIwghb+AgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCDF0RkbDwH3sY5l1U7mLRRr0ZzhBe+69OMe
# gA41nwqiUwIGZLhK8WGUGBMyMDIzMDcyNjA5MjIyNC43MDNaMASAAgH0oIHYpIHV
...
# BDAvBgkqhkiG9w0BCQQxIgQg5gBaS5EcP32s3zUDAZHqYYY10ATyft7u2Xm4u1eU
# 9tkwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCApVb08M25w+tYGWsmlGtp1
...
# rpuVscb6dZlh5QOfYHRfMA0GCSqGSIb3DQEBCwUABIICAEuvFwi2fQHxlt1mzixw
# MXRhbg9C2G4mAzBOzGWKNFhXHHa89am5GURLB3tJzfXAPCyRs+qPHlhG8LHKo4X7
# W1tflzkLys/A+1tZP316c3euz/Swa9pa8G/rc7KkJZluQhUmx8/BSpIetmS35C7l
# eXibMWTNmgNf5Hb+PgkRV75NLFGioMiJIsWCQiF8o9ggZgLRce/cqf2KNXaPLcsc
# 0zIN1tise7fCW3qqCdMxMfXQxIR11SujvB8NjKfXQx//ZGLRqEcZ7m7c5JXXw2J5
# +qfa7swOixXVJg+Ws7tmcQAwHdGoUFUvFsBYT1ijfBVdrY+dVVagToHbEpLp5+X/
# lTdgJdnsCUNL4dbojNVFS7Q758k+cxeIYOxApJaM4GVfYor+LY92kL/oVP8mHYhT
# fYl/jRyi7qvoVTc6NutnDSX6oE5n8mtfna+F1BXhMCd8X6QOtQt1ag5YUf0/ob0Y
# Bskey6Wvi9/ct/+XGuw4ESasyrRLdnT9Pyz7U6qadPJAZcRDPzxIRsaVcqDiZJ4y
# z8iH4OzCaJj6Z0/kjeFi4UOv2gC5x6uVBcINFW4uQm9xAY7ltRdpw+NuGdp1ap4I
# YoEjmpsPsrCWu+ptCxJhHfQvY4qmVaTkAwzvXfFQbgBOfJCvbalCeYjgCEF/89K3
# JfxjVlhDwU2vlMo9v/GZL6KX
